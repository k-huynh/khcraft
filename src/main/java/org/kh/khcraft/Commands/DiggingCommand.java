...
public class DiggingCommand extends SkillCommands implements TabExecutor {
    public DiggingCommand(Khcraft instance) {
        plugin = instance;
    ...
    public List<String> getIncompatibleEnchantments(String toolName, String enchantmentName) {
        ...
        List<String> incompatibleEnchants = config.getStringList(String.format("skills.%s.incompatible.%s", "digging", toolName));
