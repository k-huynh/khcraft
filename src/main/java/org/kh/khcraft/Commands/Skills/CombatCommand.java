...
public class CombatCommand extends SkillCommands implements TabExecutor {
    public CombatCommand(Khcraft instance) {
        plugin = instance;
    ...
    public List<String> getIncompatibleEnchantments(String toolName, String enchantmentName) {
        ...
        List<String> incompatibleEnchants = config.getStringList(String.format("skills.%s.incompatible.%s", "combat", toolName));
