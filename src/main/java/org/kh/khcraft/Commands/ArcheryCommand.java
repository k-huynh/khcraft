...
public class ArcheryCommand extends SkillCommands implements TabExecutor {
    public ArcheryCommand(Khcraft instance) {
        plugin = instance;
    ...
    public List<String> getIncompatibleEnchantments(String toolName, String enchantmentName) {
        ...
        List<String> incompatibleEnchants = config.getStringList(String.format("skills.%s.incompatible.%s", "archery", toolName));
